module GeoGeo
  class Shape2D
    ...
    # @param [Integral] left
    # @param [Integral] right
    # @param [Integral] bottom
    # @param [Integral] top
  ...
  class Polygon < Shape2D
    ...
    # @param [Array<Array<Integral>>] verts List of vertices in clockwise order. If verts[0]!=verts[-1], a copy of the first vert will be appended.
    # @param [Array<Integral>] center The center point of the polygon. Defaults to the center of the AABB
